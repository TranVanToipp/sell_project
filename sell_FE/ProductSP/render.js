        ...
        <div class="home-product">
				...
				<a href ="#" class="chitiet-item__product col l-2-4 m-4 c-6" style="text-decoration: none;">
                    <div class="home-product-item">
                            <div class="home-product-item-img" style="background-image:url(./assets/photos/'#");"</div>
                            <h4 class="home-product-item-name">Điện thoại thông minh</h4>
                        <div class="home-product-item-price">
                            <span class="home-product-item__price-current">'.number_format(($product_item->price-$product_item->price*$product_item->discount/100)).' ₫</span>
                            <span class="home-product-item__price-old">'.number_format($product_item->price).' ₫</span>
                        </div>
